...
public class IncomeServelt extends HttpServlet {
	 ...
	 throws ServletException, IOException
	 {
		 String begin=request.getParameter("BeginTime");
	        ...
	        {
	        ArrayList<Din> listnew=din.income(connection, begin, time);
	    
	        System.out.println("list的长度是多少"+listnew.size());
	        
	        ArrayList list33=new ArrayList();
	        for(int i=0;i<listnew.size();i++){
	        	list33.add(listnew.get(i).getJiage());
	        	
	        }
	        System.out.println("list3"+list33.size());
	        int income33=0;
	        for(int i=0;i<list33.size();i++){
	        	income33=income33+(int)list33.get(i);
	        }
	        System.out.println("income="+income33);
	        request.getSession().setAttribute("begin", begin);
	        request.getSession().setAttribute("time", time);
	        request.getSession().setAttribute("income33", income33);
	        request.getSession().setAttribute("list33", list33);
	        
	 }
	        ArrayList<Din> listincome=din.income(connection, "2015-12-31","2016-02-01");
	        ArrayList<Din> listincome2=din.income(connection, "2016-01-31","2016-03-01");
	        ArrayList<Din> listincome3=din.income(connection, "2016-02-29","2016-04-01");
	        ArrayList<Din> listincome4=din.income(connection, "2016-03-31","2016-05-01");
	        ArrayList<Din> listincome5=din.income(connection, "2016-04-30","2016-06-01");
	        ArrayList<Din> listincome6=din.income(connection, "2016-05-31","2016-07-01");
	        ArrayList<Din> listincome7=din.income(connection, "2016-06-30","2016-08-01");
	        ArrayList<Din> listincome8=din.income(connection, "2016-07-31","2016-09-01");
	        ArrayList<Din> listincome9=din.income(connection, "2016-08-31","2016-10-01");
	        ArrayList<Din> listincome10=din.income(connection, "2016-09-30","2016-11-01");
	        ArrayList<Din> listincome11=din.income(connection, "2016-10-31","2016-12-01");
	        ArrayList<Din> listincome12=din.income(connection, "2016-11-30","2017-01-01");
