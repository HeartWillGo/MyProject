...
<style type="text/css">
    ...
    #banner{width:90%;height:20%;float:left;background-color:#2a3342;}
    #banner_right{width:10%;height:20%;float:left;background-color:#2a3342;}
    #body{width:100%;height:80%;}
    #left{width:20%;height:100%;float:left;background-color: #2a3342;}
    #middle{width:60%;height:100%;float:left;background-color: #2a3342}
    #right{width:20%;height:100%;float:left;background-color: #2a3342}
    -->
    a:link {
        color:#9F9D81;
...
<form name="form1" method="post" action="LoginServlet">
    ...
    <p align="center">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <input name="Sub2" type="submit" id="Sub2" value="重置" class="style4">
    </p>
</form>
    </div>
        <div id="right">
